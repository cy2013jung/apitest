...
public class ApprovalServiceServiceLocator extends org.apache.axis.client.Service implements com.hanwha.neo.branch.ss.approval.axisws.ApprovalServiceService {
    ...
    private java.lang.String ApprovalService_address = "http://qcells.circle.hanwha.com/api/axis/services/ApprovalService";
    ...
    public com.hanwha.neo.branch.ss.approval.axisws.ApprovalService getApprovalService() throws javax.xml.rpc.ServiceException {
    ...
    public com.hanwha.neo.branch.ss.approval.axisws.ApprovalService getApprovalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hanwha.neo.branch.ss.approval.axisws.ApprovalServiceSoapBindingStub _stub = new com.hanwha.neo.branch.ss.approval.axisws.ApprovalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hanwha.neo.branch.ss.approval.axisws.ApprovalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hanwha.neo.branch.ss.approval.axisws.ApprovalServiceSoapBindingStub _stub = new com.hanwha.neo.branch.ss.approval.axisws.ApprovalServiceSoapBindingStub(new java.net.URL(ApprovalService_address), this);
                _stub.setPortName(getApprovalServiceWSDDServiceName());
                return _stub;
            }
        }
