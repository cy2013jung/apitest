...
public class MailServiceServiceLocator extends org.apache.axis.client.Service implements com.hanwha.neo.branch.ss.mail.service.MailServiceService {
    ...
    private java.lang.String MailService_address = "http://qcells.circle.hanwha.com/api/axis/services/MailService";
    ...
    public com.hanwha.neo.branch.ss.mail.service.MailService getMailService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hanwha.neo.branch.ss.mail.service.MailServiceSoapBindingStub _stub = new com.hanwha.neo.branch.ss.mail.service.MailServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hanwha.neo.branch.ss.mail.service.MailService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hanwha.neo.branch.ss.mail.service.MailServiceSoapBindingStub _stub = new com.hanwha.neo.branch.ss.mail.service.MailServiceSoapBindingStub(new java.net.URL(MailService_address), this);
                _stub.setPortName(getMailServiceWSDDServiceName());
                return _stub;
            }
        }
