...
public class MailServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.hanwha.neo.branch.ss.mail.service.MailService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.hanwha.neo.branch.ss.mail.vo.WsMailStatus[].class);
    ...
    public MailServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.hanwha.neo.branch.ss.common.vo.WsAttachFile.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.hanwha.neo.branch.ss.mail.vo.WsMailInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.hanwha.neo.branch.ss.mail.vo.WsMailStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.hanwha.neo.branch.ss.mail.vo.WsRecipient.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.hanwha.neo.branch.ss.mail.vo.WsResource.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.hanwha.neo.branch.ss.mail.vo.WsScheduleInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {mailKey});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.hanwha.neo.branch.ss.mail.vo.WsMailStatus[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.hanwha.neo.branch.ss.mail.vo.WsMailStatus[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.hanwha.neo.branch.ss.mail.vo.WsMailStatus[].class);
            }
        }
