...
public class NeoSloWsProxy implements com.hanwha.neo.branch.common.sso.service.NeoSloWs {
  private String _endpoint = null;
  private com.hanwha.neo.branch.common.sso.service.NeoSloWs neoSloWs = null;
  ...
  private void _initNeoSloWsProxy() {
    try {
      neoSloWs = (new com.hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceLocator()).getNeoSloWsImplPort();
      if (neoSloWs != null) {
        if (_endpoint != null)
  ...
  public com.hanwha.neo.branch.common.sso.service.NeoSloWs getNeoSloWs() {
    if (neoSloWs == null)
      _initNeoSloWsProxy();
    return neoSloWs;
  }
