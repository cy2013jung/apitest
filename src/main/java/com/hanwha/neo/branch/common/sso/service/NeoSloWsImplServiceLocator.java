...
package com.hanwha.neo.branch.common.sso.service;

public class NeoSloWsImplServiceLocator extends org.apache.axis.client.Service implements com.hanwha.neo.branch.common.sso.service.NeoSloWsImplService {
    ...
    private java.lang.String NeoSloWsImplPort_address = "http://qcells.circle.hanwha.com/api/ss/neoslo";
    ...
    public com.hanwha.neo.branch.common.sso.service.NeoSloWs getNeoSloWsImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.hanwha.neo.branch.common.sso.service.NeoSloWs getNeoSloWsImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub _stub = new com.hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hanwha.neo.branch.common.sso.service.NeoSloWs.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub _stub = new com.hanwha.neo.branch.common.sso.service.NeoSloWsImplServiceSoapBindingStub(new java.net.URL(NeoSloWsImplPort_address), this);
                _stub.setPortName(getNeoSloWsImplPortWSDDServiceName());
                return _stub;
            }
        }
